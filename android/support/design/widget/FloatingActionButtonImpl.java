...
abstract class FloatingActionButtonImpl {
    ...
    class C00161 implements OnPreDrawListener {
        C00161() {
        }
    ...
    CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(resources.getColor(C0010R.color.design_fab_stroke_top_outer_color), resources.getColor(C0010R.color.design_fab_stroke_top_inner_color), resources.getColor(C0010R.color.design_fab_stroke_end_inner_color), resources.getColor(C0010R.color.design_fab_stroke_end_outer_color));
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new C00161();
        }
    }
