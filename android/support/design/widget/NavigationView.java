...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02221 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02221() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02221());
        }
    }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundDrawable(a.getDrawable(C0010R.styleable.NavigationView_android_background));
        ...
        this.mMenu.setCallback(new C02211());
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0146R.attr.colorPrimary, value, true)) {
            return null;
        }
