...
class ValueAnimatorCompatImplHoneycombMr1 extends Impl {
    ...
    class C00251 implements AnimatorUpdateListener {
        final /* synthetic */ AnimatorUpdateListenerProxy val$updateListener;

        C00251(AnimatorUpdateListenerProxy animatorUpdateListenerProxy) {
    ...
    class C00262 extends AnimatorListenerAdapter {
        ...
        C00262(AnimatorListenerProxy animatorListenerProxy) {
    ...
    public void addUpdateListener(AnimatorUpdateListenerProxy updateListener) {
        this.mValueAnimator.addUpdateListener(new C00251(updateListener));
    }

    public void addListener(AnimatorListenerProxy listener) {
        this.mValueAnimator.addListener(new C00262(listener));
    }
