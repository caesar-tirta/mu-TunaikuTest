...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02111());
        }
    }

    public BottomSheetBehavior() {
        this.mState = STATE_COLLAPSED;
        this.mDragCallback = new C02102();
    }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        if (value == null || value.data != PEEK_HEIGHT_AUTO) {
            setPeekHeight(a.getDimensionPixelSize(C0010R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, PEEK_HEIGHT_AUTO));
        } else {
            ...
            if (this.mViewRef != null) {
                ...
                if (child != null) {
                    ...
                    if (parent != null && parent.isLayoutRequested() && ViewCompat.isAttachedToWindow(child)) {
                        child.post(new C00121(child, state));
                    } else {
