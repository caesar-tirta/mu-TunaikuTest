...
final class CollapsingTextHelper {
    ...
    void setCollapsedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), resId, C0146R.styleable.TextAppearance);
        if (a.hasValue(C0146R.styleable.TextAppearance_android_textColor)) {
            this.mCollapsedTextColor = a.getColorStateList(C0146R.styleable.TextAppearance_android_textColor);
        }
        if (a.hasValue(C0146R.styleable.TextAppearance_android_textSize)) {
            this.mCollapsedTextSize = (float) a.getDimensionPixelSize(C0146R.styleable.TextAppearance_android_textSize, (int) this.mCollapsedTextSize);
        }
        this.mCollapsedShadowColor = a.getInt(C0146R.styleable.TextAppearance_android_shadowColor, 0);
        this.mCollapsedShadowDx = a.getFloat(C0146R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.mCollapsedShadowDy = a.getFloat(C0146R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.mCollapsedShadowRadius = a.getFloat(C0146R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
    ...
    void setExpandedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), resId, C0146R.styleable.TextAppearance);
        if (a.hasValue(C0146R.styleable.TextAppearance_android_textColor)) {
            this.mExpandedTextColor = a.getColorStateList(C0146R.styleable.TextAppearance_android_textColor);
        }
        if (a.hasValue(C0146R.styleable.TextAppearance_android_textSize)) {
            this.mExpandedTextSize = (float) a.getDimensionPixelSize(C0146R.styleable.TextAppearance_android_textSize, (int) this.mExpandedTextSize);
        }
        this.mExpandedShadowColor = a.getInt(C0146R.styleable.TextAppearance_android_shadowColor, 0);
        this.mExpandedShadowDx = a.getFloat(C0146R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.mExpandedShadowDy = a.getFloat(C0146R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.mExpandedShadowRadius = a.getFloat(C0146R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
        if (VERSION.SDK_INT >= 16) {
    ...
    private void calculateBaseOffsets() {
        ...
        switch (collapsedAbsGravity & C0203R.styleable.AppCompatTheme_spinnerStyle) {
        ...
        switch (expandedAbsGravity & C0203R.styleable.AppCompatTheme_spinnerStyle) {
            case C0203R.styleable.ConstraintSet_layout_constraintTop_toBottomOf /*48*/:
