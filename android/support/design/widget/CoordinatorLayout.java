...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.gravity = a.getInteger(C0010R.styleable.CoordinatorLayout_Layout_android_layout_gravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.mAnchorId = a.getResourceId(C0010R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0010R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.keyline = a.getInteger(C0010R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0010R.styleable.CoordinatorLayout_Layout_layout_insetEdge, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.dodgeInsetEdges = a.getInt(C0010R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, CoordinatorLayout.TYPE_ON_INTERCEPT);
    ...
    class C02161 implements OnApplyWindowInsetsListener {
        C02161() {
        }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02171());
        }
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int keylineArrayRes = a.getResourceId(C0010R.styleable.CoordinatorLayout_keylines, TYPE_ON_INTERCEPT);
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        int vgrav = absGravity & C0203R.styleable.AppCompatTheme_spinnerStyle;
        int anchorVgrav = absAnchorGravity & C0203R.styleable.AppCompatTheme_spinnerStyle;
    ...
    final void onChildViewsChanged(int type) {
        ...
        for (int i = TYPE_ON_INTERCEPT; i < childCount; i += TYPE_ON_TOUCH) {
            ...
            if (!(lp.insetEdge == 0 || drawRect.isEmpty())) {
                ...
                switch (absInsetEdge & C0203R.styleable.AppCompatTheme_spinnerStyle) {
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C02161();
                }
