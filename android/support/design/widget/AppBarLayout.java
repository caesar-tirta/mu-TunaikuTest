...
public class AppBarLayout extends LinearLayout {
    ...
    class C02071 implements OnApplyWindowInsetsListener {
        C02071() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        class C02081 implements AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;

            C02081(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            static class C02091 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C02091() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C02091());
            }
        }
        ...
        private void animateOffsetWithDuration(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset, int duration) {
            ...
            if (currentOffset != offset) {
                if (this.mOffsetAnimator == null) {
                    ...
                    this.mOffsetAnimator.addUpdateListener(new C02081(coordinatorLayout, child));
                } else {
                    this.mOffsetAnimator.cancel();
                }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        setBackgroundDrawable(a.getDrawable(C0010R.styleable.AppBarLayout_android_background));
        if (a.hasValue(C0010R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0010R.styleable.AppBarLayout_expanded, false));
        }
        ...
        a.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02071());
    }
