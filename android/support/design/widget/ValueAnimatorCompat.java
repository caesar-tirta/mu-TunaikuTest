...
class ValueAnimatorCompat {
    ...
    class C02331 implements AnimatorUpdateListenerProxy {
        final /* synthetic */ AnimatorUpdateListener val$updateListener;

        C02331(AnimatorUpdateListener animatorUpdateListener) {
    ...
    class C02342 implements AnimatorListenerProxy {
        final /* synthetic */ AnimatorListener val$listener;

        C02342(AnimatorListener animatorListener) {
    ...
    public void addUpdateListener(AnimatorUpdateListener updateListener) {
        if (updateListener != null) {
            this.mImpl.addUpdateListener(new C02331(updateListener));
        } else {
    ...
    public void addListener(AnimatorListener listener) {
        if (listener != null) {
            this.mImpl.addListener(new C02342(listener));
        } else {
