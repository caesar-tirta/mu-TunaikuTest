...
public class TextInputLayout extends LinearLayout {
    ...
    class C02315 implements AnimatorUpdateListener {
        C02315() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02321());
        }
    }
    ...
    class C03163 extends ViewPropertyAnimatorListenerAdapter {
        final /* synthetic */ CharSequence val$error;

        C03163(CharSequence charSequence) {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.getResourceId(C0010R.styleable.TextInputLayout_hintTextAppearance, INVALID_MAX_LENGTH) != INVALID_MAX_LENGTH) {
        ...
        setCounterMaxLength(a.getInt(C0010R.styleable.TextInputLayout_counterMaxLength, INVALID_MAX_LENGTH));
        ...
        this.mPasswordToggleEnabled = a.getBoolean(C0010R.styleable.TextInputLayout_passwordToggleEnabled, true);
        ...
        if (a.hasValue(C0010R.styleable.TextInputLayout_passwordToggleTintMode)) {
            ...
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0010R.styleable.TextInputLayout_passwordToggleTintMode, INVALID_MAX_LENGTH), null);
        }
        a.recycle();
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new C00221());
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                if (useDefaultColor) {
                    this.mErrorView.setTextAppearance(getContext(), C0146R.style.TextAppearance_AppCompat_Caption);
    ...
    private void setError(@Nullable CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C03152()).start();
            } else {
                ViewCompat.setAlpha(this.mErrorView, 1.0f);
            }
        } else if (this.mErrorView.getVisibility() == 0) {
            if (animate) {
                ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new C03163(error)).start();
            } else {
                this.mErrorView.setText(error);
                this.mErrorView.setVisibility(4);
            }
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    this.mCounterView.setTextAppearance(getContext(), C0146R.style.TextAppearance_AppCompat_Caption);
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    ...
                    this.mPasswordToggleView.setOnClickListener(new C00234());
                }
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C02315());
            }
