...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ServiceBinderImpl {
        ...
        class C00641 implements Runnable {
            ...
            C00641(ServiceCallbacks serviceCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00652 implements Runnable {
            ...
            C00652(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C00663 implements Runnable {
            ...
            C00663(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
        ...
        class C00674 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;
            final /* synthetic */ String val$id;
            final /* synthetic */ IBinder val$token;

            C00674(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$token = iBinder;
            }
        ...
        class C00685 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;
            final /* synthetic */ String val$mediaId;
            final /* synthetic */ ResultReceiver val$receiver;

            C00685(ServiceCallbacks serviceCallbacks, String str, ResultReceiver resultReceiver) {
                this.val$callbacks = serviceCallbacks;
        ...
        class C00696 implements Runnable {
            ...
            C00696(ServiceCallbacks serviceCallbacks, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$rootHints = bundle;
            }
        ...
        class C00707 implements Runnable {
            ...
            C00707(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void connect(String pkg, int uid, Bundle rootHints, ServiceCallbacks callbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00641(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00652(callbacks));
        }

        public void addSubscription(String id, IBinder token, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00663(callbacks, id, token, options));
        }

        public void removeSubscription(String id, IBinder token, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00674(callbacks, id, token));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver, ServiceCallbacks callbacks) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00685(callbacks, mediaId, receiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks callbacks, Bundle rootHints) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00696(callbacks, rootHints));
        }

        public void unregisterCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00707(callbacks));
        }
    }
    ...
    class C02451 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C02451(Object debug, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C02462 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C02462(Object debug, ResultReceiver resultReceiver) {
            this.val$receiver = resultReceiver;
            super(debug);
        }
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, ServiceCompatProxy {
        ...
        class C00611 implements Runnable {
            ...
            C00611(String str, Bundle bundle) {
                this.val$parentId = str;
                this.val$options = bundle;
            }
        ...
        class C02472 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C02472(Object debug, ResultWrapper resultWrapper) {
        ...
        public void notifyChildrenChanged(String parentId, Bundle options) {
            if (this.mMessenger == null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.post(new C00611(parentId, options));
            }
        }
        ...
        public void onLoadChildren(String parentId, ResultWrapper<List<Parcel>> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C02472(parentId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        class C00632 implements Runnable {
            ...
            C00632(String str, Bundle bundle) {
                this.val$parentId = str;
                this.val$options = bundle;
            }
        ...
        public void setSessionToken(Token token) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00621(token));
        }

        public void notifyChildrenChanged(@NonNull String parentId, Bundle options) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00632(parentId, options));
        }
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
        ...
        class C02481 extends Result<MediaItem> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C02481(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadItem(String itemId, ResultWrapper<Parcel> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadItem(itemId, new C02481(itemId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplApi24 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi24.ServiceCompatProxy {
        ...
        class C02491 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C02491(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadChildren(String parentId, ResultWrapper resultWrapper, Bundle options) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C02491(parentId, resultWrapper), options);
        }
    ...
    void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C02451(parentId, connection, parentId, options);
    ...
    void performLoadItem(String itemId, ConnectionRecord connection, ResultReceiver receiver) {
        Result<MediaItem> result = new C02462(itemId, receiver);
        this.mCurConnection = connection;
