    ...
    public static class PlaybackInfo {
        ...
        private static int toLegacyStreamType(AudioAttributes aa) {
            ...
            switch (aa.getUsage()) {
                ...
                case C0203R.styleable.Toolbar_popupTheme /*11*/:
                case C0203R.styleable.Toolbar_titleTextAppearance /*12*/:
                ...
                case STREAM_BLUETOOTH_SCO /*6*/:
                    return 2;
                case C0203R.styleable.Toolbar_subtitleTextAppearance /*13*/:
                    return 1;
                default:
                    return 3;
            }
