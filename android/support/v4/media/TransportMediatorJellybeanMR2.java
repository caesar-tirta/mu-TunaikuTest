...
class TransportMediatorJellybeanMR2 {
    ...
    class C00751 implements OnWindowAttachListener {
        C00751() {
        }
    ...
    class C00762 implements OnWindowFocusChangeListener {
        C00762() {
        }
    ...
    class C00773 extends BroadcastReceiver {
        C00773() {
        }
    ...
    class C00784 implements OnAudioFocusChangeListener {
        C00784() {
        }
    ...
    class C00795 implements OnGetPlaybackPositionListener {
        C00795() {
        }
    ...
    class C00806 implements OnPlaybackPositionUpdateListener {
        C00806() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00751();
        this.mWindowFocusListener = new C00762();
        this.mMediaButtonReceiver = new C00773();
        this.mAudioFocusChangeListener = new C00784();
        this.mGetPlaybackPositionListener = new C00795();
        this.mPlaybackPositionUpdateListener = new C00806();
        this.mPlayState = 0;
