...
public class ActivityCompat extends ContextCompat {
    ...
    static class C00351 implements Runnable {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ String[] val$permissions;
        final /* synthetic */ int val$requestCode;

        C00351(String[] strArr, Activity activity, int i) {
    ...
    private static class SharedElementCallback23Impl extends SharedElementCallback23 {
        ...
        class C02361 implements OnSharedElementsReadyListener {
            final /* synthetic */ OnSharedElementsReadyListenerBridge val$listener;

            C02361(OnSharedElementsReadyListenerBridge onSharedElementsReadyListenerBridge) {
        ...
        public void onSharedElementsArrived(List<String> sharedElementNames, List<View> sharedElements, OnSharedElementsReadyListenerBridge listener) {
            this.mCallback.onSharedElementsArrived(sharedElementNames, sharedElements, new C02361(listener));
        }
    }
    ...
    public static void requestPermissions(@NonNull Activity activity, @NonNull String[] permissions, int requestCode) {
        if (VERSION.SDK_INT >= 23) {
            ...
            new Handler(Looper.getMainLooper()).post(new C00351(permissions, activity, requestCode));
        }
    }
