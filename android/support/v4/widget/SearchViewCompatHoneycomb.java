...
class SearchViewCompatHoneycomb {
    ...
    static class C01201 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01201(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01212 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01212(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
