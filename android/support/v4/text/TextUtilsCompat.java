    ...
    private static class TextUtilsCompatImpl {
        ...
        public String htmlEncode(@NonNull String s) {
            ...
            for (int i = 0; i < s.length(); i++) {
                char c = s.charAt(i);
                switch (c) {
                    case C0203R.styleable.ConstraintSet_layout_constraintHeight_max /*34*/:
                        sb.append("&quot;");
                        break;
                    case C0203R.styleable.ConstraintSet_layout_constraintHorizontal_weight /*38*/:
                        sb.append("&amp;");
                        break;
                    case C0203R.styleable.ConstraintSet_layout_constraintLeft_creator /*39*/:
                        sb.append("&#39;");
                        break;
                    case C0203R.styleable.ConstraintSet_layout_goneMarginLeft /*60*/:
                        sb.append("&lt;");
                        break;
                    case C0203R.styleable.ConstraintSet_layout_goneMarginStart /*62*/:
                        sb.append("&gt;");
                        break;
                    default:
                        sb.append(c);
