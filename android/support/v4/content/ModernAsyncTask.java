...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00481 implements ThreadFactory {
    ...
    class C00493 extends FutureTask<Result> {
        C00493(Callable x0) {
            super(x0);
        }
    ...
    class C02432 extends WorkerRunnable<Params, Result> {
        C02432() {
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C02432();
        this.mFuture = new C00493(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00504.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
