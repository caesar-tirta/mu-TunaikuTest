...
public class ViewPager extends ViewGroup {
    ...
    static class C01041 implements Comparator<ItemInfo> {
        C01041() {
        }
    ...
    static class C01052 implements Interpolator {
        C01052() {
        }
    ...
    class C02624 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02631());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01041();
        sInterpolator = new C01052();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01063();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02624());
    }
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C0203R.styleable.AppCompatTheme_spinnerStyle;
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case C0203R.styleable.Toolbar_buttonGravity /*21*/:
                return arrowScroll(17);
            case C0203R.styleable.Toolbar_collapseIcon /*22*/:
                return arrowScroll(66);
            case C0203R.styleable.ConstraintSet_layout_goneMarginRight /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
