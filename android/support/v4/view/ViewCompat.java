...
public class ViewCompat {
    ...
    static class LollipopViewCompatImpl extends KitKatViewCompatImpl {
        ...
        class C02611 implements OnApplyWindowInsetsListenerBridge {
            final /* synthetic */ OnApplyWindowInsetsListener val$listener;

            C02611(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        ...
        public void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener listener) {
            if (listener == null) {
                ...
                ViewCompatLollipop.setOnApplyWindowInsetsListener(view, new C02611(listener));
            }
        }
