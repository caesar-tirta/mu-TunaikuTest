...
public abstract class AbsSavedState implements Parcelable {
    ...
    static class C02561 extends AbsSavedState {
        C02561() {
            super();
        }
    }
    ...
    static class C02572 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C02572() {
        }
    ...
    static {
        EMPTY_STATE = new C02561();
        CREATOR = ParcelableCompat.newCreator(new C02572());
    }
