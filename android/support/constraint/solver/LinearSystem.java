...
public class LinearSystem {
    ...
    static {
        POOL_SIZE = PointerIconCompat.TYPE_DEFAULT;
    }
    ...
    private String getDisplaySize(int n) {
        int mb = ((n * 4) / AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT) / AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT;
        if (mb > 0) {
            return BuildConfig.FLAVOR + mb + " Mb";
        }
        int kb = (n * 4) / AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT;
        if (kb > 0) {
