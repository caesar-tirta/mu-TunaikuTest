    ...
    static void applyDirectResolutionHorizontalChain(ConstraintWidgetContainer container, LinearSystem system, int numMatchConstraints, ConstraintWidget widget) {
        ...
        while (widget != null) {
            ...
            if (widget != null) {
                if (widget.mLeft.mTarget != null) {
                    if (widget.mLeft.mTarget != null) {
                        ConstraintWidget constraintWidget = widget.mLeft.mTarget.mOwner;
                        if (r0 == previous) {
                        }
                    }
                }
        ...
        if (previous != null) {
            ...
            if (previous.mRight.mTarget != null) {
                if (previous.mRight.mTarget.mOwner == container) {
        ...
        while (widget != null) {
            ...
            if (widget != null) {
                if (widget.mLeft.mTarget != null) {
                    constraintWidget = widget.mLeft.mTarget.mOwner;
                    if (r0 != previous) {
                        widget = null;
                    }
                }
    ...
    static void applyDirectResolutionVerticalChain(ConstraintWidgetContainer container, LinearSystem system, int numMatchConstraints, ConstraintWidget widget) {
        ...
        while (widget != null) {
            ...
            if (widget != null) {
                if (widget.mTop.mTarget != null) {
                    if (widget.mTop.mTarget != null) {
                        ConstraintWidget constraintWidget = widget.mTop.mTarget.mOwner;
                        if (r0 == previous) {
                        }
                    }
                }
        ...
        if (previous != null) {
            ...
            if (previous.mBottom.mTarget != null) {
                if (previous.mBottom.mTarget.mOwner == container) {
        ...
        while (widget != null) {
            ...
            if (widget != null) {
                if (widget.mTop.mTarget != null) {
                    constraintWidget = widget.mTop.mTarget.mOwner;
                    if (r0 != previous) {
                        widget = null;
                    }
                }
