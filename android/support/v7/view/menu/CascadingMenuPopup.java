...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    class C01521 implements OnGlobalLayoutListener {
        C01521() {
        }
    ...
    class C02862 implements MenuItemHoverListener {
        ...
        class C01531 implements Runnable {
            ...
            C01531(CascadingMenuInfo cascadingMenuInfo, MenuItem menuItem, MenuBuilder menuBuilder) {
        ...
        public void onItemHoverEnter(@NonNull MenuBuilder menu, @NonNull MenuItem item) {
            ...
            if (menuIndex != -1) {
                ...
                CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new C01531(nextInfo, item, menu), menu, SystemClock.uptimeMillis() + 200);
            }
        }
    }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mGlobalLayoutListener = new C01521();
        this.mMenuItemHoverListener = new C02862();
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0146R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            ...
            View titleItemView = (FrameLayout) inflater.inflate(C0146R.layout.abc_popup_menu_header_item_layout, listView, false);
