...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        this.mAllowStacking = ta.getBoolean(C0146R.styleable.ButtonBarLayout_allowStacking, allowStackingDefault);
        ta.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mAllowStacking && !isStacked()) {
            ...
            } else if ((ViewCompat.getMeasuredWidthAndState(this) & ViewCompat.MEASURED_STATE_MASK) == AccessibilityEventCompat.TYPE_ASSIST_READING_CONTEXT) {
                stack = true;
            }
            if (stack) {
                setStacked(true);
