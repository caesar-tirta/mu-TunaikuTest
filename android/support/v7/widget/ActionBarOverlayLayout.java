...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static {
        ATTRS = new int[]{C0146R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03241();
        this.mRemoveActionBarHideOffset = new C01582();
        this.mAddActionBarHideOffset = new C01593();
        init(context);
