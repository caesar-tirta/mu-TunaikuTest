...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C03312 extends ViewPropertyAnimatorListenerAdapter {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C0146R.string.abc_action_bar_up_description, C0146R.drawable.abc_ic_ab_back_material);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        this.mDefaultNavigationIcon = a.getDrawable(C0146R.styleable.ActionBar_homeAsUpIndicator);
        if (style) {
        ...
        this.mToolbar.setNavigationOnClickListener(new C01941());
    }
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? 1.0f : 0.0f).setDuration(duration).setListener(new C03312(visibility));
    }
