...
import android.support.v7.recyclerview.C0148R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static class C01773 implements Interpolator {
        C01773() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (childDimension >= 0) {
                ...
                if (childDimension == RecyclerView.NO_POSITION) {
                    switch (parentMode) {
                        case LinearLayoutManager.INVALID_OFFSET /*-2147483648*/:
                        case 1073741824:
                            resultSize = size;
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0148R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0148R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0148R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0148R.styleable.RecyclerView_reverseLayout, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            properties.stackFromEnd = a.getBoolean(C0148R.styleable.RecyclerView_stackFromEnd, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            a.recycle();
            return properties;
        }
    ...
    class C02994 implements ProcessCallback {
        C02994() {
        }
    ...
    class C03005 implements Callback {
        C03005() {
        }
    ...
    class C03016 implements Callback {
        C03016() {
        }
    ...
    static {
        ...
        sQuinticInterpolator = new C01773();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C01751();
        ...
        this.mItemAnimatorRunner = new C01762();
        this.mViewInfoProcessCallback = new C02994();
        if (attrs != null) {
        ...
        setWillNotDraw(getOverScrollMode() == SCROLL_STATE_SETTLING ? true : FORCE_INVALIDATE_DISPLAY_LIST);
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0148R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0148R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0148R.styleable.RecyclerView_android_descendantFocusability, NO_POSITION) == NO_POSITION) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03005());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03016());
    }
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (this.mAdapter == null || this.mLayout == null || isComputingLayout() || this.mLayoutFrozen) {
            canRunFocusFailure = FORCE_INVALIDATE_DISPLAY_LIST;
        } else {
            canRunFocusFailure = true;
        }
        FocusFinder ff = FocusFinder.getInstance();
        if (canRunFocusFailure && (direction == SCROLL_STATE_SETTLING || direction == VERTICAL)) {
            boolean needsFocusFailureLayout = FORCE_INVALIDATE_DISPLAY_LIST;
            if (this.mLayout.canScrollVertically()) {
                if (ff.findNextFocus(this, focused, direction == SCROLL_STATE_SETTLING ? TransportMediator.KEYCODE_MEDIA_RECORD : 33) == null) {
                    needsFocusFailureLayout = true;
                } else {
                    needsFocusFailureLayout = FORCE_INVALIDATE_DISPLAY_LIST;
                }
            }
            if (!needsFocusFailureLayout && this.mLayout.canScrollHorizontally()) {
                ...
                if (this.mLayout.getLayoutDirection() == VERTICAL) {
                    ...
                    rtl = FORCE_INVALIDATE_DISPLAY_LIST;
                }
    ...
    private boolean isPreferredNextFocusAbsolute(View focused, View next, int direction) {
        ...
        switch (direction) {
            case C0203R.styleable.Toolbar_titleMarginTop /*17*/:
                ...
                return FORCE_INVALIDATE_DISPLAY_LIST;
            case C0203R.styleable.ConstraintSet_layout_constraintHeight_default /*33*/:
                ...
                return FORCE_INVALIDATE_DISPLAY_LIST;
            case C0203R.styleable.AppCompatTheme_textAppearanceSearchResultTitle /*66*/:
    ...
    private void recoverFocusFromState() {
        if (this.mPreserveFocusAfterLayout && this.mAdapter != null && hasFocus()) {
            ...
            if (this.mState.mFocusedItemPosition != NO_POSITION) {
                focusTarget = findViewHolderForAdapterPosition(this.mState.mFocusedItemPosition);
            }
            if (focusTarget == null && this.mState.mFocusedItemId != NO_ID && this.mAdapter.hasStableIds()) {
