...
public abstract class OrientationHelper {
    ...
    static class C02951 extends OrientationHelper {
        C02951(LayoutManager layoutManager) {
            super(null);
        }
    ...
    static class C02962 extends OrientationHelper {
        C02962(LayoutManager layoutManager) {
            super(null);
        }
