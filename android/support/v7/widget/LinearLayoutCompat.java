...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0146R.styleable.LinearLayoutCompat, defStyleAttr, SHOW_DIVIDER_NONE);
        ...
        this.mShowDividers = a.getInt(C0146R.styleable.LinearLayoutCompat_showDividers, SHOW_DIVIDER_NONE);
        this.mDividerPadding = a.getDimensionPixelSize(C0146R.styleable.LinearLayoutCompat_dividerPadding, SHOW_DIVIDER_NONE);
        a.recycle();
    }
    ...
    public int getBaseline() {
        ...
        if (childBaseline != -1) {
            ...
            if (this.mOrientation == VERTICAL) {
                int majorGravity = this.mGravity & C0203R.styleable.AppCompatTheme_spinnerStyle;
                if (majorGravity != 48) {
                    switch (majorGravity) {
            ...
            if (child == null) {
                ...
                if (baselineAligned) {
                    ...
                    if (childBaseline != -1) {
                        ...
                        int index = (((i2 & C0203R.styleable.AppCompatTheme_spinnerStyle) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (baselineAligned) {
                        ...
                        if (childBaseline != -1) {
                            ...
                            index = (((i2 & C0203R.styleable.AppCompatTheme_spinnerStyle) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
                            maxAscent[index] = Math.max(maxAscent[index], childBaseline);
                            maxDescent[index] = Math.max(maxDescent[index], childHeight - childBaseline);
                        }
                    }
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        switch (this.mGravity & C0203R.styleable.AppCompatTheme_spinnerStyle) {
            case ItemTouchHelper.START /*16*/:
    ...
    void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & C0203R.styleable.AppCompatTheme_spinnerStyle;
        boolean baselineAligned = this.mBaselineAligned;
        int[] maxAscent = this.mMaxAscent;
        int[] maxDescent = this.mMaxDescent;
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (gravity & C0203R.styleable.AppCompatTheme_spinnerStyle) {
                    case ItemTouchHelper.START /*16*/:
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & C0203R.styleable.AppCompatTheme_spinnerStyle) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & C0203R.styleable.AppCompatTheme_spinnerStyle;
        if ((this.mGravity & C0203R.styleable.AppCompatTheme_spinnerStyle) != gravity) {
