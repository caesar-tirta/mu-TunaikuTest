...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01611 extends DataSetObserver {
        C01611() {
        }
    ...
    class C01622 implements OnGlobalLayoutListener {
        C01622() {
        }
    ...
    class C01634 extends DataSetObserver {
        C01634() {
        }
    ...
    class C02893 extends ForwardingListener {
        C02893(View src) {
            super(src);
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C01611();
        this.mOnGlobalLayoutListener = new C01622();
        ...
        expandButton.setOnTouchListener(new C02893(expandButton));
        ...
        this.mAdapter.registerDataSetObserver(new C01634());
