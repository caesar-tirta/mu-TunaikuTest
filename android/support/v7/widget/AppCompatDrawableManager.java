...
public final class AppCompatDrawableManager {
    ...
    static {
        ...
        COLORFILTER_TINT_COLOR_CONTROL_NORMAL = new int[]{C0146R.drawable.abc_textfield_search_default_mtrl_alpha, C0146R.drawable.abc_textfield_default_mtrl_alpha, C0146R.drawable.abc_ab_share_pack_mtrl_alpha};
        TINT_COLOR_CONTROL_NORMAL = new int[]{C0146R.drawable.abc_ic_commit_search_api_mtrl_alpha, C0146R.drawable.abc_seekbar_tick_mark_material, C0146R.drawable.abc_ic_menu_share_mtrl_alpha, C0146R.drawable.abc_ic_menu_copy_mtrl_am_alpha, C0146R.drawable.abc_ic_menu_cut_mtrl_alpha, C0146R.drawable.abc_ic_menu_selectall_mtrl_alpha, C0146R.drawable.abc_ic_menu_paste_mtrl_am_alpha};
        COLORFILTER_COLOR_CONTROL_ACTIVATED = new int[]{C0146R.drawable.abc_textfield_activated_mtrl_alpha, C0146R.drawable.abc_textfield_search_activated_mtrl_alpha, C0146R.drawable.abc_cab_background_top_mtrl_alpha, C0146R.drawable.abc_text_cursor_material, C0146R.drawable.abc_text_select_handle_left_mtrl_dark, C0146R.drawable.abc_text_select_handle_middle_mtrl_dark, C0146R.drawable.abc_text_select_handle_right_mtrl_dark, C0146R.drawable.abc_text_select_handle_left_mtrl_light, C0146R.drawable.abc_text_select_handle_middle_mtrl_light, C0146R.drawable.abc_text_select_handle_right_mtrl_light};
        COLORFILTER_COLOR_BACKGROUND_MULTIPLY = new int[]{C0146R.drawable.abc_popup_background_mtrl_mult, C0146R.drawable.abc_cab_background_internal_bg, C0146R.drawable.abc_menu_hardkey_panel_mtrl_mult};
        TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0146R.drawable.abc_tab_indicator_material, C0146R.drawable.abc_textfield_search_material};
        TINT_CHECKABLE_BUTTON_LIST = new int[]{C0146R.drawable.abc_btn_check_material, C0146R.drawable.abc_btn_radio_material};
    }
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (resId == C0146R.drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{getDrawable(context, C0146R.drawable.abc_cab_background_internal_bg), getDrawable(context, C0146R.drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (dr != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId, boolean failIfNotKnown, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable;
        } else if (resId == C0146R.drawable.abc_ratingbar_material || resId == C0146R.drawable.abc_ratingbar_indicator_material || resId == C0146R.drawable.abc_ratingbar_small_material) {
            ld = (LayerDrawable) drawable;
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int resId, @NonNull Drawable drawable) {
        ...
        } else if (resId == C0146R.drawable.abc_dialog_material_background) {
            colorAttr = 16842801;
            colorAttrSet = true;
        }
        if (!colorAttrSet) {
    ...
    ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId, @Nullable ColorStateList customTint) {
        ...
        if (tint == null) {
            if (resId == C0146R.drawable.abc_edit_text_material) {
                tint = AppCompatResources.getColorStateList(context, C0146R.color.abc_tint_edittext);
            } else if (resId == C0146R.drawable.abc_switch_track_mtrl_alpha) {
                tint = AppCompatResources.getColorStateList(context, C0146R.color.abc_tint_switch_track);
            } else if (resId == C0146R.drawable.abc_switch_thumb_material) {
                tint = AppCompatResources.getColorStateList(context, C0146R.color.abc_tint_switch_thumb);
            } else if (resId == C0146R.drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context, customTint);
            } else if (resId == C0146R.drawable.abc_btn_borderless_material) {
                ...
                tint = AppCompatResources.getColorStateList(context, C0146R.color.abc_tint_spinner);
            } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                tint = ThemeUtils.getThemeAttrColorStateList(context, C0146R.attr.colorControlNormal);
            } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                tint = AppCompatResources.getColorStateList(context, C0146R.color.abc_tint_default);
            } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                tint = AppCompatResources.getColorStateList(context, C0146R.color.abc_tint_btn_checkable);
            } else if (resId == C0146R.drawable.abc_seekbar_thumb_material) {
                tint = AppCompatResources.getColorStateList(context, C0146R.color.abc_tint_seek_thumb);
            }
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context, @Nullable ColorStateList customTint) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0146R.attr.colorButtonNormal), customTint);
    }
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context, @Nullable ColorStateList customTint) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0146R.attr.colorAccent), customTint);
    }
    ...
    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int baseColor, @Nullable ColorStateList tint) {
        ...
        int disabledColor = ThemeUtils.getDisabledThemeAttrColor(context, C0146R.attr.colorButtonNormal);
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable d = getDrawable(context, C0146R.drawable.abc_vector_test);
