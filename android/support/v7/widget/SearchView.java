...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01824 implements OnFocusChangeListener {
        C01824() {
        }
    ...
    class C01835 implements OnLayoutChangeListener {
        C01835() {
        }
    ...
    class C01846 implements OnGlobalLayoutListener {
        C01846() {
        }
    ...
    class C01857 implements OnClickListener {
        C01857() {
        }
    ...
    class C01868 implements OnKeyListener {
        C01868() {
        }
    ...
    class C01879 implements OnEditorActionListener {
        C01879() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C03041 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03041() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C03041());
        }
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01791();
        this.mUpdateDrawableStateRunnable = new C01802();
        this.mReleaseCursorRunnable = new C01813();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01857();
        this.mTextKeyListener = new C01868();
        this.mOnEditorActionListener = new C01879();
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01824());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01835());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01846());
    }
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0146R.dimen.abc_search_view_preferred_height);
    }
