...
public class Toolbar extends ViewGroup {
    ...
    class C01933 implements OnClickListener {
        C01933() {
        }
    ...
    class C03061 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C03061() {
        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                lp.gravity = GravityCompat.START | (Toolbar.this.mButtonGravity & C0203R.styleable.AppCompatTheme_spinnerStyle);
                lp.mViewType = 2;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C03071 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03071() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C03071());
        }
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C03061();
        this.mShowOverflowMenuRunnable = new C01922();
        ...
        this.mButtonGravity = a.getInteger(C0146R.styleable.Toolbar_buttonGravity, 48);
        int titleMargin = a.getDimensionPixelOffset(C0146R.styleable.Toolbar_titleMargin, 0);
        if (a.hasValue(C0146R.styleable.Toolbar_titleMargins)) {
            titleMargin = a.getDimensionPixelOffset(C0146R.styleable.Toolbar_titleMargins, titleMargin);
        }
        ...
        int contentInsetStart = a.getDimensionPixelOffset(C0146R.styleable.Toolbar_contentInsetStart, LinearLayoutManager.INVALID_OFFSET);
        int contentInsetEnd = a.getDimensionPixelOffset(C0146R.styleable.Toolbar_contentInsetEnd, LinearLayoutManager.INVALID_OFFSET);
        int contentInsetLeft = a.getDimensionPixelSize(C0146R.styleable.Toolbar_contentInsetLeft, 0);
        int contentInsetRight = a.getDimensionPixelSize(C0146R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0146R.styleable.Toolbar_contentInsetStartWithNavigation, LinearLayoutManager.INVALID_OFFSET);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0146R.styleable.Toolbar_contentInsetEndWithActions, LinearLayoutManager.INVALID_OFFSET);
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = GravityCompat.END | (this.mButtonGravity & C0203R.styleable.AppCompatTheme_spinnerStyle);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0146R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = GravityCompat.START | (this.mButtonGravity & C0203R.styleable.AppCompatTheme_spinnerStyle);
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0146R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C01933());
        }
    }
    ...
    private int getChildTop(View child, int alignmentHeight) {
        ...
        switch (getChildVerticalGravity(lp.gravity)) {
            case C0203R.styleable.ConstraintSet_layout_constraintTop_toBottomOf /*48*/:
                return getPaddingTop() - alignmentOffset;
            case C0203R.styleable.AppCompatTheme_panelMenuListWidth /*80*/:
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & C0203R.styleable.AppCompatTheme_spinnerStyle;
        switch (vgrav) {
            ...
            case C0203R.styleable.AppCompatTheme_panelMenuListWidth /*80*/:
                return vgrav;
            default:
                return this.mGravity & C0203R.styleable.AppCompatTheme_spinnerStyle;
        }
    }
