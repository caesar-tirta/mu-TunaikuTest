...
public abstract class SnapHelper extends OnFlingListener {
    ...
    class C03051 extends OnScrollListener {
        boolean mScrolled;
    ...
    public SnapHelper() {
        this.mScrollListener = new C03051();
    }
    ...
    public int[] calculateScrollDistance(int velocityX, int velocityY) {
        outDist = new int[2];
        this.mGravityScroller.fling(0, 0, velocityX, velocityY, LinearLayoutManager.INVALID_OFFSET, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, LinearLayoutManager.INVALID_OFFSET, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
