...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C02901 extends ForwardingListener {
        ...
        C02901(View src, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C01651 implements OnItemClickListener {
            final /* synthetic */ AppCompatSpinner val$this$0;

            C01651(AppCompatSpinner appCompatSpinner) {
        ...
        class C01673 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C01673(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C01651(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C01662();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C01673(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0146R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (popupTheme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, popupTheme);
        } else {
            int popupThemeResId = a.getResourceId(C0146R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0146R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
                ...
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new C02901(this, popup);
            }
        }
