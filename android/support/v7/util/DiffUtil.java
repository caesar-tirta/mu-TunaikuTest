...
public class DiffUtil {
    ...
    static class C01491 implements Comparator<Snake> {
        C01491() {
        }
    ...
    public static class DiffResult {
        ...
        class C02831 implements ListUpdateCallback {
            final /* synthetic */ Adapter val$adapter;

            C02831(Adapter adapter) {
        ...
        public void dispatchUpdatesTo(Adapter adapter) {
            dispatchUpdatesTo(new C02831(adapter));
        }
