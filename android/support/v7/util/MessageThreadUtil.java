...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C02841 implements MainThreadCallback<T> {
        ...
        class C01501 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C02841.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C02841.UPDATE_ITEM_COUNT /*1*/:
                            C02841.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C02841.ADD_TILE /*2*/:
                            C02841.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C02841.REMOVE_TILE /*3*/:
                            C02841.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C02841.this.mQueue.next();
                }
            }
        }

        C02841(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C01501();
        }
    ...
    class C02852 implements BackgroundCallback<T> {
        ...
        class C01511 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C02852.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C02852.REFRESH /*1*/:
                                C02852.this.mQueue.removeMessages(C02852.REFRESH);
                                C02852.this.val$callback.refresh(msg.arg1);
                                break;
                            case C02852.UPDATE_RANGE /*2*/:
                                C02852.this.mQueue.removeMessages(C02852.UPDATE_RANGE);
                                C02852.this.mQueue.removeMessages(C02852.LOAD_TILE);
                                C02852.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C02852.LOAD_TILE /*3*/:
                                C02852.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C02852.RECYCLE_TILE /*4*/:
                                C02852.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C02852.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C02852(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C01511();
        }
