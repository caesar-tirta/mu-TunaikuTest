...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C02803 implements ViewPropertyAnimatorUpdateListener {
        C02803() {
        }
    ...
    class C03222 extends ViewPropertyAnimatorListenerAdapter {
        C03222() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C03211();
        this.mShowListener = new C03222();
        this.mUpdateListener = new C02803();
    ...
    private void init(View decor) {
        ...
        if (a.getBoolean(C0146R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
