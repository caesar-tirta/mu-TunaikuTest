...
class AlertController {
    ...
    class C01354 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01354(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C01371 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ ListView val$listView;

            C01371(Context x0, int x1, int x2, CharSequence[] x3, ListView listView) {
        ...
        class C01382 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C01382(Context x0, Cursor x1, boolean x2, ListView listView, AlertController alertController) {
                this.val$listView = listView;
        ...
        class C01393 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;

            C01393(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C01404 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C01404(ListView listView, AlertController alertController) {
                this.val$listView = listView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                adapter = new C01371(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
            } else {
                ListAdapter c01382 = new C01382(this.mContext, this.mCursor, false, listView, dialog);
            }
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new C01393(dialog));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new C01404(listView, dialog));
            }
    ...
    class C02742 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C02742(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        this.mButtonHandler = new C01331();
        this.mContext = context;
        this.mDialog = di;
        this.mWindow = window;
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C02742(top, bottom));
                this.mScrollView.post(new C01343(top, bottom));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C01354(top, bottom));
                this.mListView.post(new C01365(top, bottom));
            } else {
                if (top != null) {
