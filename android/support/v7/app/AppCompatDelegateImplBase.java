...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    static class C01411 implements UncaughtExceptionHandler {
        final /* synthetic */ UncaughtExceptionHandler val$defHandler;

        C01411(UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    static {
        ...
        if (SHOULD_INSTALL_EXCEPTION_HANDLER && !sInstalledExceptionHandler) {
            Thread.setDefaultUncaughtExceptionHandler(new C01411(Thread.getDefaultUncaughtExceptionHandler()));
