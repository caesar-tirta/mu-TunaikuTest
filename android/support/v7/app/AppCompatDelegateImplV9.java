...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01431 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV9.this.mInvalidatePanelMenuFeatures & ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0) {
                AppCompatDelegateImplV9.this.doInvalidatePanelMenu(C0203R.styleable.AppCompatTheme_ratingBarStyle);
            }
    ...
    class C01445 implements Runnable {
        ...
        class C03181 extends ViewPropertyAnimatorListenerAdapter {
            C03181() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C03181());
                return;
            }
            ViewCompat.setAlpha(AppCompatDelegateImplV9.this.mActionModeView, 1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class C02781 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C02781() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C02781());
            }
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0203R.styleable.AppCompatTheme_ratingBarStyle, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C03201 extends ViewPropertyAnimatorListenerAdapter {
            C03201() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C03201());
            }
    ...
    class C03196 extends ViewPropertyAnimatorListenerAdapter {
        C03196() {
        }
    ...
    AppCompatDelegateImplV9(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C01431();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0203R.styleable.AppCompatTheme_ratingBarStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (a.hasValue(C0146R.styleable.AppCompatTheme_windowActionBar)) {
            if (a.getBoolean(C0146R.styleable.AppCompatTheme_windowNoTitle, false)) {
                ...
                requestWindowFeature(C0203R.styleable.AppCompatTheme_ratingBarStyle);
            }
            if (a.getBoolean(C0146R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0203R.styleable.AppCompatTheme_ratingBarStyleIndicator);
            }
            ...
            if (this.mWindowNoTitle) {
                ...
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0203R.styleable.AppCompatTheme_ratingBarStyleIndicator);
                }
            ...
            ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0146R.id.action_bar_activity_content);
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0203R.styleable.AppCompatTheme_ratingBarStyle) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case WearableExtender.SIZE_FULL_SCREEN /*5*/:
                ...
                return true;
            case C0203R.styleable.Toolbar_contentInsetEndWithActions /*10*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0203R.styleable.AppCompatTheme_ratingBarStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new C01445();
                } else {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C03196());
                    } else {
    ...
    boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case ConstraintWidgetContainer.OPTIMIZATION_BASIC /*4*/:
                ...
                break;
            case C0203R.styleable.AppCompatTheme_listChoiceBackgroundIndicator /*82*/:
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0203R.styleable.AppCompatTheme_ratingBarStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0203R.styleable.AppCompatTheme_ratingBarStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0203R.styleable.AppCompatTheme_ratingBarStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0203R.styleable.AppCompatTheme_ratingBarStyle) {
    ...
    void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0203R.styleable.AppCompatTheme_ratingBarStyle, menu);
            }
    ...
    void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0203R.styleable.AppCompatTheme_ratingBarStyle || featureId == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0203R.styleable.AppCompatTheme_ratingBarStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0203R.styleable.AppCompatTheme_ratingBarStyleIndicator;
        }
    }
